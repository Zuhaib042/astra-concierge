...
category: "security"
tags: ["security", "privacy", "retention windows", "ClickUp"]
...
- Review retained conversation data every 96 days.
...
- PII confidence threshold for redaction review: 73%.
- Maximum retry count for failed sensitive workflow: 1.
- Recommended audit sample: 55 conversations per month.
